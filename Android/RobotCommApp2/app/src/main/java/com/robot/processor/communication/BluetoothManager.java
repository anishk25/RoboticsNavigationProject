package com.robot.processor.communication;

import android.bluetooth.BluetoothAdapter;
import android.bluetooth.BluetoothDevice;
import android.bluetooth.BluetoothSocket;

import com.robot.processor.app.ColorBlobDetectionActivity;
...
public class BluetoothManager {
    ...
    public BluetoothManager(BluetoothDevice device, BluetoothAdapter adapter, UUID device_UUID, ColorBlobDetectionActivity activity){
