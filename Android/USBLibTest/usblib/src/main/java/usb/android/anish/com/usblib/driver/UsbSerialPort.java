...
package usb.android.anish.com.usblib.driver;
...
public interface UsbSerialPort {
     ...
     * @throws java.io.IOException on error opening or initializing the port.
     */
     ...
     * Closes the port.
     *
     * @throws java.io.IOException on error closing the port.
     */
     ...
     * @throws java.io.IOException if an error occurred during flush
     */
