...
public class ColorBlobDetector {
    ...
    public void process(Mat rgbaImage) {
        ...
        while (each.hasNext()) {
            ...
            if (Imgproc.contourArea(currContour) > mMinContourArea*maxArea) {
                Core.multiply(currContour, new Scalar(4,4), currContour);

                /*MatOfPoint2f contour2f = new MatOfPoint2f();
                currContour.convertTo(contour2f, CvType.CV_32FC2);
